...
export function GoalCard({ goalId, dragHandleOnly = false }) {
  ...
  return (
    <motion.div
      ...
      className={cn(
        'group cursor-grab select-none rounded-lg border border-border bg-surface p-4 shadow-card active:cursor-grabbing',
        'hover:border-ink-200 hover:shadow-raised transition-shadow',
    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0 flex-1">
          ...
          <h3 className="truncate font-display text-[15px] font-semibold leading-snug text-ink-900">
            {goal.title}
          </h3>
        </div>
